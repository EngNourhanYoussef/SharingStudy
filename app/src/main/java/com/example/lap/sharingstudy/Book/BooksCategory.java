package com.example.lap.sharingstudy.Book;
...
public class BooksCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.listview_branch_books);
        TextView mEmptyStateTextView = findViewById(R.id.empty_books_view);
