...
import com.example.lap.sharingstudy.Book.BooksCategory;
import com.example.lap.sharingstudy.Disussion.DiscussionScreen;
import com.example.lap.sharingstudy.Disussion.DiscussionSubmit;
import com.example.lap.sharingstudy.Download.Download;
import com.example.lap.sharingstudy.Forum.ForumAdapter;
import com.example.lap.sharingstudy.Forum.ForumQuestion;
import com.example.lap.sharingstudy.Upload.ShareBook;
import com.example.lap.sharingstudy.Upload.Upload;
...
import com.example.lap.sharingstudy.News.NewsMainActivity;
...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout = findViewById(R.id.activity_home_swipe_refresh_layout);
        ...
        final ChildEventListener childEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
                ...
                if (Objects.equals(dataSnapshot.getKey(), "forums")) {
        ...
        connectivityManager.registerNetworkCallback(
                ...
                new ConnectivityManager.NetworkCallback() {
                    ...
                    @Override
                    public void onAvailable(Network network) {  Toast.makeText(Home.this, R.string.toast_loading,
                            Toast.LENGTH_SHORT).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        TextView t = findViewById(R.id.current_user_email);
        TextView t1 =  findViewById(R.id.current_user);
        if (t != null)
            t.setText(email);
        else
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_forum) {
            ...
            sharingIntent.setType(String.valueOf(R.string.text_type));
            String shareBody = getString(R.string.ShareBook);
            sharingIntent.putExtra(Intent.EXTRA_SUBJECT, (R.string.SUBJECT));
            sharingIntent.putExtra(Intent.EXTRA_TEXT, shareBody);
            startActivity(Intent.createChooser(sharingIntent, (String.valueOf(R.string.Share))));
